...
public class CartController {
    ...
    public @ResponseBody ResponseEntity order(@RequestBody CartProductDTO cartProductDTO, BindingResult bindingResult, Principal principal){
    ...
    public String cartList(Model model) {
        ...
        for(CartProductDTO cartProductDTO : cartLists){
            totalPrice+= cartProductDTO.getCount()*cartProductDTO.getProductPrice();
        }
